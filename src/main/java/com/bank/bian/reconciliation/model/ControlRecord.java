package com.bank.bian.reconciliation.model;
...
/**
 * The BIAN control record for this service domain: "Reconciliation Case Procedure".
 *
 ...
 * to its asset type (Reconciliation Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Reconciliation Case Procedure";
